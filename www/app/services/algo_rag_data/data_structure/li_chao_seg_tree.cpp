// The Li Chao Segment Tree is a data structure used to maintain a dynamic set of linear functions and efficiently query the minimum or maximum value at a given point.
